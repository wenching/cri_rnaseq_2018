...
def pheatmap(args, sw_cfg, task_cfg):
    """
    pheatmap

    :parm args: an argparse.Namespace object of main argumens {.log_file}
    :parm sw_cfg: a dictionary of corresponding software configureation {pheatmap}
    :parm task_cfg: a dictionary of corresponding task configureation {pheatmap}
    ...
    sw_cfg_tool = sw_cfg['pheatmap']

    task_cfg_proj = task_cfg['pheatmap']
